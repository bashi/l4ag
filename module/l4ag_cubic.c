/*
 * TCP CUBIC for Layer 4 aggregation.
 * This is a modified version of net/ipv4/tcp_cubic.c
 */
...
{
    DBG(KERN_INFO "l4agcub: init called.\n");
...
static void bictcp_cong_avoid(struct sock *sk, u32 ack, u32 in_flight)
{
    ...
    DBG(KERN_INFO "l4agcub: cong_avoid called.\n");
...
struct tcp_congestion_ops cubicl4ag = {
	.init		= bictcp_init,
...
int cubicl4ag_register(void)
{
	...
	return tcp_register_congestion_control(&cubicl4ag);
}

void cubicl4ag_unregister(void)
{
	tcp_unregister_congestion_control(&cubicl4ag);
}
